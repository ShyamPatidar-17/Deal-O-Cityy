...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to={'/'}> <img src={assets.logo} alt="LOGO IMAGE" className='w-36 h-15' /></Link>
  ...
  >
    ...
    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
      ...
      <div className='flex items-center gap-6'>
        <Link to={'/collection'}> <img src={assets.search_icon} alt="" className='w-5 cursor-pointer' onClick={() => setShowSearch(true)} /></Link>
